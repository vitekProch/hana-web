        ...
        <Container className="mt-5">
            <Row>
                ...
                <Col xs={12} md={12} lg={6} align="end" className="al">
                    <img className="about-me-photo" src="https://good-puce-llama-yoke.cyclic.app/images/o_mne_1.jpg" alt="Hanka" />
                </Col>
            </Row>
            ...
            <Row>
                ...
                <Col xs={12} md={12} lg={6} align="end" className="al">
                    <img className="about-me-photo" src="https://good-puce-llama-yoke.cyclic.app/images/o_mne_3.jpg" alt="Hanka" />
                </Col>
            </Row>
            <Row className="flex-column-reverse flex-lg-row">
                <Col xs={12} md={12} lg={6} align="">
